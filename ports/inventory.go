...
type InventoryRepository interface {
	...
	GetAllInventory(tenantID string) ([]*dto.EnhancedInventory, *responses.InternalResponse)
	...
	ValidateImportRows(rows []requests.InventoryImportRow, tenantID string) ([]responses.InventoryValidationResult, *responses.InternalResponse)
	ExportInventoryToExcel(tenantID string) ([]byte, *responses.InternalResponse)
	...
	GetValuation(groupBy string, tenantID string) (*responses.InventoryValuationResponse, *responses.InternalResponse)
}
